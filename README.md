...
This release hides unexpected widgets during tab detachment so only the
functional toolbox and diagram remain, eliminating inert duplicates that
previously appeared in detached windows.
# AutoML
