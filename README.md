...
This release restores duplicate pruning after tab detachment so the
detached window keeps only the edge toolbox and diagram, removing stray
widgets that previously lingered in the middle.
# AutoML
