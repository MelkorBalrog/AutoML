...
"""CapsuleButton interaction tests for detached tabs."""
...
class TestCapsuleButtonDetachedTab:
    def _detach(self, nb: ClosableNotebook) -> CapsuleButton:
        """Detach first tab and return cloned button."""
    ...
    def test_hover_events_no_error(self):
        try:
            root = tk.Tk()
        except tk.TclError:
