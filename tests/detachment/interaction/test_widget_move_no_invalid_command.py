...
"""Grouped tests ensuring moved widgets avoid invalid command errors."""
...
class TestMovedWidgetInteraction:
    """Grouped tests for interacting with moved widgets in detached windows."""

    def test_clicking_moved_widget_has_no_invalid_command(self, monkeypatch):
        try:
            root = tk.Tk()
        except tk.TclError:
